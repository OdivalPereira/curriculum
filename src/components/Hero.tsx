    ...
    <section id="about" className="bg-[#1A1D24] border border-slate-800 rounded-2xl p-6 shadow-xl">
      ...
      >
        ...
        {info?.avatar_url ? (
          ...
          <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-emerald-400 rounded-full mb-4 flex items-center justify-center text-3xl font-bold text-white">
            {displayInitials}
          </div>
        )}
        ...
        {loading ? (
          <div className="animate-pulse space-y-3">
             ...
             <div className="h-16 bg-slate-800 rounded w-full mt-4"></div>
          </div>
        ) : (
          <>
            ...
            <p className="text-slate-400 text-sm mt-4 leading-relaxed whitespace-pre-line">
              {displayBio}
            </p>
          </>
        )}
